        ...
        case 0:
          L1: do {
            ...
            L2: do {
                L3: while (true) {
                if (!true) break L3;
                  i_11990069 = i_12010225;
                  n_11990070 = content_type_kstring_11981003[chckIndx(i_12010225, 0, (content_type_kstring_11981003 != null ? content_type_kstring_11981003.length : 0)+0-1)-0];
                  if ((entry_11985405 == n_11990070)) {
                  shown_content_11981043[0] = i_11990069;
                  }
...
function title_11981047(typ_11981049) {
    var Tmp1;

  var result_11981050 = null;
    ...
    result_11981050 = Tmp1;

  return result_11981050;
...
function content_11981064(typ_11981066, part_11981067) {
        var Tmp1;
        var Tmp2;
        var Tmp3;
        var Tmp4;
  ...
  var result_11981068 = null;

    var tmp_11981105 = tree_9830445(43, []);
    tmp_11981105.class = "content";
    switch (typ_11981066) {
    case 0:
      switch (toJSStr(part_11981067)) {
      case "title":
        add_9820072(tmp_11981105, text_9830601(about_title_11981009[chckIndx(language_11981044[0], 0, (about_title_11981009 != null ? about_title_11981009.length : 0)+0-1)-0]));
        break;
      case "text":
        var tmp_11981111 = tree_9830445(31, []);
        add_9820072(tmp_11981111, text_9830601(about_text_11981018[chckIndx(language_11981044[0], 0, (about_text_11981018 != null ? about_text_11981018.length : 0)+0-1)-0]));
        add_9820072(tmp_11981105, tmp_11981111);
        break;
      default: 
        break;
      }
    ...
    case 1:
      switch (toJSStr(part_11981067)) {
      case "title":
        add_9820072(tmp_11981105, text_9830601(skills_title_11981012[chckIndx(language_11981044[0], 0, (skills_title_11981012 != null ? skills_title_11981012.length : 0)+0-1)-0]));
        break;
      case "text":
        var tmp_11981112 = tree_9830445(31, []);
        add_9820072(tmp_11981112, text_9830601(skills_text_11981021[chckIndx(language_11981044[0], 0, (skills_text_11981021 != null ? skills_text_11981021.length : 0)+0-1)-0]));
        add_9820072(tmp_11981105, tmp_11981112);
        break;
      default: 
        break;
      }
    ...
    case 2:
      switch (toJSStr(part_11981067)) {
      case "title":
        add_9820072(tmp_11981105, text_9830601(projects_title_11981015[chckIndx(language_11981044[0], 0, (projects_title_11981015 != null ? projects_title_11981015.length : 0)+0-1)-0]));
        break;
      case "text":
        var tmp_11981113 = tree_9830445(43, []);
        tmp_11981113.class = "projects";
        var tmp_11981114 = tree_9830445(43, []);
        tmp_11981114.class = "project";
        var tmp_11981115 = tree_9830445(23, []);
        add_9820072(tmp_11981115, text_9830548((Tmp1 = [makeNimstrLit("Apache log viewer & filter"), makeNimstrLit("N\xC3\xA1stroj pre zobrazovanie a filtrovanie Apache logov")], Tmp1)[chckIndx(language_11981044[0], 0, (Tmp1 != null ? Tmp1.length : 0)+0-1)-0]));
        add_9820072(tmp_11981114, tmp_11981115);
        var tmp_11981116 = tree_9830445(43, []);
        tmp_11981116.class = "language";
        var tmp_11981117 = tree_9830445(31, []);
        tmp_11981117.class = "left";
        add_9820072(tmp_11981117, text_9830548((Tmp2 = [makeNimstrLit("Language:"), makeNimstrLit("Jazyk:")], Tmp2)[chckIndx(language_11981044[0], 0, (Tmp2 != null ? Tmp2.length : 0)+0-1)-0]));
        add_9820072(tmp_11981116, tmp_11981117);
        var tmp_11981118 = tree_9830445(31, []);
        tmp_11981118.class = "right";
        add_9820072(tmp_11981118, text_9830548(makeNimstrLit("Shell script")));
        add_9820072(tmp_11981116, tmp_11981118);
        add_9820072(tmp_11981114, tmp_11981116);
        var tmp_11981119 = tree_9830445(43, []);
        tmp_11981119.class = "os";
        var tmp_11981120 = tree_9830445(31, []);
        tmp_11981120.class = "left";
        add_9820072(tmp_11981120, text_9830548(makeNimstrLit("OS:")));
        add_9820072(tmp_11981119, tmp_11981120);
        var tmp_11981121 = tree_9830445(31, []);
        tmp_11981121.class = "right";
        add_9820072(tmp_11981121, text_9830548(makeNimstrLit("Linux, BSD, MacOS")));
        add_9820072(tmp_11981119, tmp_11981121);
        add_9820072(tmp_11981114, tmp_11981119);
        var tmp_11981122 = tree_9830445(43, []);
        tmp_11981122.class = "links";
        var tmp_11981123 = tree_9830445(44, []);
        tmp_11981123.class = "button github";
        set_attr_9770105(tmp_11981123, "href", "https://github.com/adokitkat/vut-fit-ios-1");
        add_9820072(tmp_11981123, text_9830548(makeNimstrLit("</> Github")));
        add_9820072(tmp_11981122, tmp_11981123);
        add_9820072(tmp_11981114, tmp_11981122);
        add_9820072(tmp_11981113, tmp_11981114);
        var tmp_11981124 = tree_9830445(43, []);
        tmp_11981124.class = "project";
        var tmp_11981125 = tree_9830445(23, []);
        add_9820072(tmp_11981125, text_9830548((Tmp3 = [makeNimstrLit("Public transport line simulator"), makeNimstrLit("Simul\xC3\xA1tor liniek hromadnej dopravy")], Tmp3)[chckIndx(language_11981044[0], 0, (Tmp3 != null ? Tmp3.length : 0)+0-1)-0]));
        add_9820072(tmp_11981124, tmp_11981125);
        var tmp_11981126 = tree_9830445(31, []);
        tmp_11981126.class = "left";
        add_9820072(tmp_11981126, text_9830548((Tmp4 = [makeNimstrLit("Uses A* path-finding algorithm"), makeNimstrLit("Pou\xC5\xBE\xC3\xADva A* algoritmus na n\xC3\xA1jdenie cesty")], Tmp4)[chckIndx(language_11981044[0], 0, (Tmp4 != null ? Tmp4.length : 0)+0-1)-0]));
        add_9820072(tmp_11981124, tmp_11981126);
        var tmp_11981127 = tree_9830445(43, []);
        tmp_11981127.class = "language";
        var tmp_11981128 = tree_9830445(31, []);
        tmp_11981128.class = "left";
        add_9820072(tmp_11981128, text_9830548((Tmp5 = [makeNimstrLit("Language:"), makeNimstrLit("Jazyk:")], Tmp5)[chckIndx(language_11981044[0], 0, (Tmp5 != null ? Tmp5.length : 0)+0-1)-0]));
        add_9820072(tmp_11981127, tmp_11981128);
        var tmp_11981129 = tree_9830445(31, []);
        tmp_11981129.class = "right";
        add_9820072(tmp_11981129, text_9830548(makeNimstrLit("C++, Qt5")));
        add_9820072(tmp_11981127, tmp_11981129);
        add_9820072(tmp_11981124, tmp_11981127);
        var tmp_11981130 = tree_9830445(43, []);
        tmp_11981130.class = "os";
        var tmp_11981131 = tree_9830445(31, []);
        tmp_11981131.class = "left";
        add_9820072(tmp_11981131, text_9830548(makeNimstrLit("OS:")));
        add_9820072(tmp_11981130, tmp_11981131);
        var tmp_11981132 = tree_9830445(31, []);
        tmp_11981132.class = "right";
        add_9820072(tmp_11981132, text_9830548(makeNimstrLit("Windows, Linux")));
        add_9820072(tmp_11981130, tmp_11981132);
        add_9820072(tmp_11981124, tmp_11981130);
        var tmp_11981133 = tree_9830445(43, []);
        tmp_11981133.class = "links";
        var tmp_11981134 = tree_9830445(44, []);
        tmp_11981134.class = "button github";
        set_attr_9770105(tmp_11981134, "href", "https://github.com/adokitkat/vut-fit-icp");
        add_9820072(tmp_11981134, text_9830548(makeNimstrLit("</> Github")));
        add_9820072(tmp_11981133, tmp_11981134);
        var tmp_11981135 = tree_9830445(44, []);
        tmp_11981135.class = "button";
        set_attr_9770105(tmp_11981135, "href", "https://github.com/adokitkat/vut-fit-icp/releases");
        add_9820072(tmp_11981135, text_9830548((Tmp6 = [makeNimstrLit("<~> Try it"), makeNimstrLit("<~> Vysk\xC3\xBA\xC5\xA1aj")], Tmp6)[chckIndx(language_11981044[0], 0, (Tmp6 != null ? Tmp6.length : 0)+0-1)-0]));
        add_9820072(tmp_11981133, tmp_11981135);
        add_9820072(tmp_11981124, tmp_11981133);
        add_9820072(tmp_11981113, tmp_11981124);
        var tmp_11981136 = tree_9830445(43, []);
        tmp_11981136.class = "project";
        var tmp_11981137 = tree_9830445(23, []);
        add_9820072(tmp_11981137, text_9830548((Tmp7 = [makeNimstrLit("Packet sniffer (IPv4)"), makeNimstrLit("Sniffer packetov (IPv4)")], Tmp7)[chckIndx(language_11981044[0], 0, (Tmp7 != null ? Tmp7.length : 0)+0-1)-0]));
        add_9820072(tmp_11981136, tmp_11981137);
        var tmp_11981138 = tree_9830445(43, []);
        tmp_11981138.class = "language";
        var tmp_11981139 = tree_9830445(31, []);
        tmp_11981139.class = "left";
        add_9820072(tmp_11981139, text_9830548((Tmp8 = [makeNimstrLit("Language:"), makeNimstrLit("Jazyk:")], Tmp8)[chckIndx(language_11981044[0], 0, (Tmp8 != null ? Tmp8.length : 0)+0-1)-0]));
        add_9820072(tmp_11981138, tmp_11981139);
        var tmp_11981140 = tree_9830445(31, []);
        tmp_11981140.class = "right";
        add_9820072(tmp_11981140, text_9830548(makeNimstrLit("C++")));
        add_9820072(tmp_11981138, tmp_11981140);
        add_9820072(tmp_11981136, tmp_11981138);
        var tmp_11981141 = tree_9830445(43, []);
        tmp_11981141.class = "os";
        var tmp_11981142 = tree_9830445(31, []);
        tmp_11981142.class = "left";
        add_9820072(tmp_11981142, text_9830548(makeNimstrLit("OS:")));
        add_9820072(tmp_11981141, tmp_11981142);
        var tmp_11981143 = tree_9830445(31, []);
        tmp_11981143.class = "right";
        add_9820072(tmp_11981143, text_9830548(makeNimstrLit("Linux")));
        add_9820072(tmp_11981141, tmp_11981143);
        add_9820072(tmp_11981136, tmp_11981141);
        var tmp_11981144 = tree_9830445(43, []);
        tmp_11981144.class = "links";
        var tmp_11981145 = tree_9830445(44, []);
        tmp_11981145.class = "button github";
        set_attr_9770105(tmp_11981145, "href", "https://github.com/adokitkat/vut-fit-ipk-2");
        add_9820072(tmp_11981145, text_9830548(makeNimstrLit("</> Github")));
        add_9820072(tmp_11981144, tmp_11981145);
        add_9820072(tmp_11981136, tmp_11981144);
        add_9820072(tmp_11981113, tmp_11981136);
        var tmp_11981146 = tree_9830445(43, []);
        tmp_11981146.class = "project";
        var tmp_11981147 = tree_9830445(23, []);
        add_9820072(tmp_11981147, text_9830548((Tmp9 = [makeNimstrLit("This portfolio page"), makeNimstrLit("T\xC3\xA1to portf\xC3\xB3lio str\xC3\xA1nka")], Tmp9)[chckIndx(language_11981044[0], 0, (Tmp9 != null ? Tmp9.length : 0)+0-1)-0]));
        add_9820072(tmp_11981146, tmp_11981147);
        var tmp_11981148 = tree_9830445(31, []);
        tmp_11981148.class = "left";
        add_9820072(tmp_11981148, text_9830548((Tmp10 = [makeNimstrLit("Single-page web app experiment with automatized building via Github Actions"), makeNimstrLit("Single-page web app experiment s automatick\xC3\xBDm stavan\xC3\xADm pomocou Github Actions")], Tmp10)[chckIndx(language_11981044[0], 0, (Tmp10 != null ? Tmp10.length : 0)+0-1)-0]));
        add_9820072(tmp_11981146, tmp_11981148);
        var tmp_11981149 = tree_9830445(43, []);
        tmp_11981149.class = "language";
        var tmp_11981150 = tree_9830445(31, []);
        tmp_11981150.class = "left";
        add_9820072(tmp_11981150, text_9830548((Tmp11 = [makeNimstrLit("Language:"), makeNimstrLit("Jazyk:")], Tmp11)[chckIndx(language_11981044[0], 0, (Tmp11 != null ? Tmp11.length : 0)+0-1)-0]));
        add_9820072(tmp_11981149, tmp_11981150);
        var tmp_11981151 = tree_9830445(31, []);
        tmp_11981151.class = "right";
        add_9820072(tmp_11981151, text_9830548((Tmp12 = [makeNimstrLit("Nim (compiled to JS), Sass"), makeNimstrLit("Nim (skompilovan\xC3\xBD na JS), Sass")], Tmp12)[chckIndx(language_11981044[0], 0, (Tmp12 != null ? Tmp12.length : 0)+0-1)-0]));
        add_9820072(tmp_11981149, tmp_11981151);
        add_9820072(tmp_11981146, tmp_11981149);
        var tmp_11981152 = tree_9830445(43, []);
        tmp_11981152.class = "links";
        var tmp_11981153 = tree_9830445(44, []);
        tmp_11981153.class = "button github";
        set_attr_9770105(tmp_11981153, "href", "https://github.com/adokitkat/adokitkat.github.io");
        add_9820072(tmp_11981153, text_9830548(makeNimstrLit("</> Github")));
        add_9820072(tmp_11981152, tmp_11981153);
        add_9820072(tmp_11981146, tmp_11981152);
        add_9820072(tmp_11981113, tmp_11981146);
        add_9820072(tmp_11981105, tmp_11981113);
        break;
      default: 
        break;
      }
    ...
    result_11981068 = tmp_11981105;

  return result_11981068;

}
function build_navbar_11990157() {
  var result_11990159 = null;

    var tmp_11990160 = tree_9830445(18, []);
    tmp_11990160.class = apply_theme_11985327("navbar");
    var tmp_11990161 = tree_9830445(43, []);
    tmp_11990161.class = "navbar-list center";
      ...
      L2: do {
        ...
        L3: do {
            ...
            if (!(res_12010212 <= 2)) break L4;
              ...
              var tmp_11990162 = tree_9830445(44, []);
              tmp_11990162.class = navbar_item_11995009;
              add_event_handler_10750154(tmp_11990162, 0, action_11985402(0, title_11981047(n_11995235)), kxi_10187284[0]);
              add_9820072(tmp_11990162, content_11981064(n_11995235, makeNimstrLit("title")));
              add_9820072(tmp_11990161, tmp_11990162);
              if ((n_11995235 < 2)) {
              var tmp_11990163 = tree_9830445(70, []);
              add_9820072(tmp_11990163, text_9830548(makeNimstrLit("/")));
              add_9820072(tmp_11990161, tmp_11990163);
              }
    ...
    var tmp_11990164 = tree_9830445(43, []);
    tmp_11990164.class = "navbar-break";
    var tmp_11990165 = tree_9830445(44, []);
    tmp_11990165.class = "navbar-item";
    add_event_handler_10750154(tmp_11990165, 0, action_11985402(1, ""), kxi_10187284[0]);
    if ((language_11981044[0] == 1)) {
    add_9820072(tmp_11990165, text_9830548(makeNimstrLit("EN")));
    }
    else {
    add_9820072(tmp_11990165, text_9830548(makeNimstrLit("SK")));
    }
    
    add_9820072(tmp_11990164, tmp_11990165);
    var tmp_11990166 = tree_9830445(70, []);
    add_9820072(tmp_11990166, text_9830548(makeNimstrLit("/")));
    add_9820072(tmp_11990164, tmp_11990166);
    var tmp_11990167 = tree_9830445(44, []);
    tmp_11990167.class = "navbar-item";
    add_event_handler_10750154(tmp_11990167, 0, action_11985402(2, ""), kxi_10187284[0]);
    if ((theme_11981045[0] == 0)) {
    add_9820072(tmp_11990167, text_9830548(makeNimstrLit("Dark")));
    }
    else {
    add_9820072(tmp_11990167, text_9830548(makeNimstrLit("Light")));
    }
    
    add_9820072(tmp_11990164, tmp_11990167);
    add_9820072(tmp_11990161, tmp_11990164);
    add_9820072(tmp_11990160, tmp_11990161);
    result_11990159 = tmp_11990160;

  return result_11990159;
...
function build_content_11995326() {
  var result_11995328 = null;
    ...
    add_9820072(tmp_11995329, content_11981064(shown_content_11981043[0], makeNimstrLit("text")));
...
function build_footer_12000018() {
  var result_12000020 = null;
    ...
    tmp_12000021.class = apply_theme_11985327("footer");
...
function create_dom_12005018(data_12005020) {
  var result_12005021 = null;
    ...
    var tmp_12005022 = tree_9830445(43, []);
    tmp_12005022.class = apply_theme_11985327("theme");
    add_9820072(tmp_12005022, build_navbar_11990157());
    add_9820072(tmp_12005022, build_content_11995326());
    add_9820072(tmp_12005022, build_footer_12000018());
    result_12005021 = tmp_12005022;
